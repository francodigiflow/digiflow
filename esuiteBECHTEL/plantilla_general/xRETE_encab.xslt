			...
			<tbody>
				<tr>
					<td width="30%" align="center">
						<table cellSpacing="0" cellPadding="0" width="100%" border="0">
							<tr><td align="left"><!-- <img src="logo_bechtel.png" /> -->
					...
					<td valign="middle" width="70%" align="center">
						   <table cellSpacing="0" cellPadding="0" width="100%" border="0">
							   <tbody>
							   <xsl:choose>
							   	<xsl:when test="//cac:PartyIdentification/cbc:ID = '20257982794'">
									<tr>
								...
								<xsl:when test="//cac:PartyIdentification/cbc:ID = '20538694836'">
									<tr>
										<td valign="top" align="left">
											<font color="#000000" size="5" face="Arial, Helvetica, sans-serif">
