...
<xsl:stylesheet version="1.0" xmlns:ds="http://www.w3.org/2000/09/xmldsig#"
   ...
   <xsl:include href="xGNAM_encab.xslt"/>
   <xsl:include href="xGNAM_detalle.xslt"/>
   <xsl:include href="xGNAM_bottom.xslt"/>
   <xsl:include href="xGNAM_datos.xslt"/>
   <xsl:include href="xGNAM_total.xslt"/>
   <xsl:template match="/">
