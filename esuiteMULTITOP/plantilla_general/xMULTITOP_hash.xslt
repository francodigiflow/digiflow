...
<xsl:stylesheet version="1.0"
   ...
   <xsl:include href="xPRUNI_encab.xslt"/>
   <xsl:include href="xPRUNI_detalle.xslt"/>
   <xsl:include href="xPRUNI_bottom.xslt"/>
   <xsl:include href="xPRUNI_datos.xslt"/>
   <xsl:include href="xPRUNI_total.xslt"/>
   <xsl:template match="/">
