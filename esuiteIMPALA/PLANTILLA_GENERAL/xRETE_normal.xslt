...
<xsl:stylesheet version="1.0" xmlns:ds="http://www.w3.org/2000/09/xmldsig#" 
	...
	<xsl:variable name="numColBl">
		<xsl:if test="/pe:Retention!=''">
			<xsl:value-of select="5-count(/pe:Invoice/cac:InvoiceLine)"/>
		</xsl:if>
	</xsl:variable>
