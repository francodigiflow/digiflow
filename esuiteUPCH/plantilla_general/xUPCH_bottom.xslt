			...
			<tbody>
				<tr>
					<td valign="baseline" width="100%" align="center">
						<font face="Arial, Helvetica, sans-serif" size="2">Representación impresa de la
							<xsl:choose>
							...
							<br/>Podrá ser consultado en www.upch.edu.pe
							<br/>Autorizado mediante Resolución de Intendencia N° 018-005-0002246/SUNAT
							<!--<br/>
