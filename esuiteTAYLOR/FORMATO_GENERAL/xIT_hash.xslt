...
<xsl:stylesheet version="1.0"
   ...
   <xsl:include href="xSimsa_encab.xslt"/>
   <xsl:include href="xSimsa_detalle.xslt"/>
   <xsl:include href="xSimsa_bottom.xslt"/>
   <xsl:include href="xSimsa_datos.xslt"/>
   <xsl:include href="xSimsa_total.xslt"/>
   <xsl:template match="/">
