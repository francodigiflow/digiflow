			...
			<body>
				<table cellSpacing="1" width="100%" border="0">
					<tbody>
						...
						<tr><td colspan="2"><xsl:call-template name="Transferencia"/></td></tr>
					...
					<tr>
						<td align="center">
							<font face="Arial, Helvetica, sans-serif" size="2">AGENTE RETENEDOR D.S. 037-2002 / SUNAT</font>
						</td>
					</tr>
					</xsl:if>-->
					<tr width="100%">
