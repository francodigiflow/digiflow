...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:ds="http://www.w3.org/2000/09/xmldsig#" xmlns:pe="urn:oasis:names:specification:ubl:schema:xsd:Invoice-2" xmlns:pe1="urn:oasis:names:specification:ubl:schema:xsd:CreditNote-2" xmlns:pe2="urn:oasis:names:specification:ubl:schema:xsd:DebitNote-2" xmlns:ext="urn:oasis:names:specification:ubl:schema:xsd:CommonExtensionComponents-2" xmlns:cbc="urn:oasis:names:specification:ubl:schema:xsd:CommonBasicComponents-2" xmlns:cac="urn:oasis:names:specification:ubl:schema:xsd:CommonAggregateComponents-2">
			...
			<tbody>
				...
				<td valign="top" width="20%" align="left">
					...
					<td valign="top" width="70%" align="center">
						<font face="Arial, Helvetica, sans-serif" size="1"><br/>Operador de servicios Electronicos<br/>
						...
						<br/>
						<!--<br/>-->
						Representacion impresa de la factura Electrónica. consulte en https://facturacion.ecomprobantes.pe/CELSA
							<br/>
	...
	<xsl:template name="bottom_hash2">
		<table border="0" bordercolor="#000000" cellpadding="0" cellspacing="0" width="100%">
			<tbody>
	<tr>
			...
			<tr align="left">
				<td width="100%" align="left">-->
					<table border="0" bordercolor="#000000" cellpadding="0" cellspacing="0" width="100%" height="60">
						<tr align="left">
							<td valign="top" align="left" height="108">
								<font face="Arial" size="1">
									...
									<img width="100" height="100" align="left" src="data:image/*;base64,[ted_1]" />
								</font>
							</td>
						</tr>
					</table>
	...
	<!--<xsl:template name="enunciado">
		<table border="0" bordercolor="#000000" cellpadding="0" cellspacing="0" width="100%">
			<tbody>
				<tr>
					<td valign="top" width="100%" align="center">
						<font face="Arial, Helvetica, sans-serif" size="1" style="text-align: justify"><br/>
							Representacion impresa de la factura Electrónica. consulte en <a href="https://pruebas.ecomprobantes.pe/CELSA" target="_blank"> www.digiflow.pe</a><br/>
							<br/>
							Autorizado mediante la Resolución de intendencia N° 034-005-0004177/SUNAT
