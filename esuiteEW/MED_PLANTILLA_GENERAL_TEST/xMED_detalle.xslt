					...
					<table rules="cols" border="1" width="100%" bordercolor="#000000" cellpadding="0" cellspacing="0">
						...
						<xsl:if test="cbc:ID &gt;'0' and cbc:ID &lt;'24'  ">
							<tr>
                        		...
                        		<td width="10%" align="center" vAlign="top"><font face="Arial, Helvetica, sans-serif" size="1">
								...
								<td width="10%" align="right" vAlign="top">
									<font face="Arial, Helvetica, sans-serif" size="1">
										<xsl:value-of select="format-number($Descuento,'###,###,##0.00','pen')"/> <br/>
									</font>
								</td>
						...
						<xsl:for-each select="/pe2:DebitNote/cac:DebitNoteLine">
							...
							<tr>
								<td width="10%" align="center" valign="top"><font face="Arial, Helvetica, sans-serif" size="2">
									<xsl:value-of select="cac:Item/cac:SellersItemIdentification/cbc:ID"/></font> 
								</td>
								<td width="10%" align="center" valign="top">
									<font face="Arial, Helvetica, sans-serif" size="1">
