...
xmlns:pe2="urn:oasis:names:specification:ubl:schema:xsd:DebitNote-2" xmlns:ext="urn:oasis:names:specification:ubl:schema:xsd:CommonExtensionComponents-2">
   ...
   <xsl:template name="bottom_Volcan">
      <table border="0" bordercolor="#000000" cellpadding="0" cellspacing="0" width="100%">
         <tbody>
            <tr>
                 <xsl:variable name="DatoAdicionalOB">
								...
								<xsl:for-each select="//ext:UBLExtensions/ext:UBLExtension/ext:ExtensionContent/pe2:DatosAdicionales/pe2:DatoAdicional">
									<xsl:if test="pe2:Codigo='01'">
									   ...
									   <xsl:if test="substring($DatoAdicionalOB,1,1) != 'G'">
							...
							<tr>
							  ...
							  <td width="52%" align="left">
                                <font face="Arial, Helvetica, sans-serif" size="1">
									...
									OPERACIONES SUJETA AL SISTEMA DE PAGO DE<br/>
									OBLIGACIONES TRIBUTARIAS CON EL GOBIERNO CENTRAL <br/>
									N° de Cuenta: Banco de la Nación <xsl:value-of select="//cac:PaymentMeans/cac:PayeeFinancialAccount/cbc:ID" />
									<!--00-068-112354-->
									</xsl:if>
