					...
					<td vAlign="top" width="50%">
						<table border="0" width="100%" bordercolor="#000000" cellpadding="2" cellspacing="2">
							<tbody>
								...
								<tr>
								    <td width="10%" align="left">
										<font face="Arial, Helvetica, sans-serif" size="2"><strong>VEHÍCULO</strong></font>
									</td>
									<td width="40%" align="left">
										<font face="Arial, Helvetica, sans-serif" size="2">:
											<xsl:for-each select="//ext:UBLExtensions/ext:UBLExtension/ext:ExtensionContent/pe:DatosAdicionales/pe:DatoAdicional">
					...
					<td vAlign="top" width="50%">
						<table border="0" width="100%" bordercolor="#000000" cellpadding="2" cellspacing="2">
							<tbody>
								...
								<tr>
                                    <td width="5%" align="left">
										<font face="Arial, Helvetica, sans-serif" size="2"><strong>DIRECCIÓN TRANSPORTISTA</strong></font>
									</td>
									<td width="35%" align="left">
										<font face="Arial, Helvetica, sans-serif" size="2">:
											<xsl:for-each select="//ext:UBLExtensions/ext:UBLExtension/ext:ExtensionContent/pe:DatosAdicionales/pe:DatoAdicional">
					...
					<td vAlign="top" width="26%">
						<table border="0" width="100%" bordercolor="#000000" cellpadding="2" cellspacing="2">
							<tbody>
								...
								<tr>
                                    <td width="15%" align="left">
										<font face="Arial, Helvetica, sans-serif" size="2"><strong>GUIA DE REMISIÓN</strong></font>
									</td>
									<td width="35%" align="left">
										<font face="Arial, Helvetica, sans-serif" size="2">:
