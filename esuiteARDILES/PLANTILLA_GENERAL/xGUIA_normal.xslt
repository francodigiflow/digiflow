					...
					<tbody>
						<div class="content">
							...
							<xsl:if test="$ContadorItem = 1">
								...
								<tr>
									<td>
										<xsl:call-template name="Cuadro_traslado"/>
									</td>
								</tr>
								<tr>
									<td>
