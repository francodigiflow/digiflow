				...
				<td>
					<table rules="cols" border="1" width="100%" bordercolor="#000000" cellpadding="2" cellspacing="0">
						...
						<xsl:if test="$v_Contador = 1 and cbc:ID &gt; 0 and cbc:ID &lt;= 11">					
							<tr>
								...
								<td width="26%" align="center" class="td_detalle">
									<font face="Arial, Helvetica, sans-serif" size="1">
					...
					<!--<xsl:call-template name="lineaBl">
						...
						<!--</xsl:call-template>-->
							...
							<td width="40%" align="center"  style="border:solid 1px black;border-top:none;border-bottom:none">
								<!--<font face="Arial, Helvetica, sans-serif" size="1">-->
							...
							<td width="26%" align="center"  style="border:solid 1px black;border-top:none;border-bottom:none">
								<!--<font face="Arial, Helvetica, sans-serif" size="1">-->
									&#xA0;
								<!--</font>-->
							</td>
