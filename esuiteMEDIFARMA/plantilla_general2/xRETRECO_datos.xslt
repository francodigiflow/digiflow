					...
					<td vAlign="top" width="100%">
						<table border="0" width="100%" bordercolor="#000000" cellpadding="2" cellspacing="2" >
							<tbody>
								...
								<tr>
									...
									<td width="2%">
										<font face="Arial, Helvetica, sans-serif" size="1">
											<!--<strong>FECHA DE EMISIÓN<xsl:if test="$varTraduc='1'"><br/>(INVOICE DATE)</xsl:if></strong>-->
										</font>
									</td>
									<td width="2%">
										<font face="Arial, Helvetica, sans-serif" size="1">
								...
								<tr>
									<td width="13%">
										<font face="Arial, Helvetica, sans-serif" size="1.5"><strong>DIRECCIÓN</strong></font>
									</td>
									<td width="83%">
										<font face="Arial, Helvetica, sans-serif" size="1.5">:
								...
								<tr >
									<td width="13%">
										<font face="Arial, Helvetica, sans-serif" size="1.5"><strong>FECHA EMISIÓN</strong></font>
									</td>
