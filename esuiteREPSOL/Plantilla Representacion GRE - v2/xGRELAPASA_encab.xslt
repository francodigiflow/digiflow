	...
	<xsl:template name="EncabezadoPeru">
		<table cellSpacing="0" border="0"  style="font-family :Arial,Helvetica,sans-serif;font-size:15px;color:#000000" >
			...
			<tr>
					...
					<td valign="top" align="left" width="69%" style="font-family :Arial,Helvetica,sans-serif;font-size:9px;color:#000000">	
					<font size="2">
					&#160;<br/>	
					<b>	<xsl:value-of select="//cac:Signature/cac:SignatoryParty/cac:PartyName"/></b>	<br/>		
					</font>
							<font size="1">
						<!--	&#160;<br/>	-->
								
							Car.Ventanilla Nro.Km25(Autopista a Ventanilla)<br/>
							Prov.Const.Del Callao-Prov. Const. Del Callao-Ventanilla<br/>
							C.Postal 10245 Lima1<br/>
							Teléfonos:(511) 517-2022|215-6225<br/>
							Fax:	  (511) 577-6412|215-6215<br/>
