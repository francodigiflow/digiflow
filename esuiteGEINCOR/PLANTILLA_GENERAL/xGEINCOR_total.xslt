...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:ds="http://www.w3.org/2000/09/xmldsig#" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:pe="urn:oasis:names:specification:ubl:schema:xsd:Invoice-2"
	...
	<xsl:template name="son-pesos">
		<table border="0" cellpadding="1" cellspacing="1" width="100%">
			...
			<xsl:if test="//cbc:UBLVersionID='2.1' and //cac:PaymentTerms/cbc:ID = 'Detraccion'">
				<xsl:if test="//cac:PaymentTerms/cbc:Amount > 0.00">	
				<tr>
					<td width="100%" colspan="4">
						<font face="Arial, Helvetica, sans-serif" size="2">
						<strong> 
							<br/>Operación sujeta a detracción: 
						</strong>
						</font>
						<xsl:call-template name="tmpDetraccion"/>
	...
	<xsl:template name="tmpDetraccion">
		<table style="border-collapse: collapse;" cellpadding="2">
			<tr>
				<td width="100px" align="center" style="border-collapse: collapse;">
					<font face="Arial, Helvetica, sans-serif" size="2">
					</font>
				</td>
				<td width="150px" align="center" style="border: black 1px solid; border-collapse: collapse; background-color:#CAC7C6;">
					<font face="Arial, Helvetica, sans-serif" size="2">
					<strong>Cuenta de Detracción</strong>
					</font>
				</td>
				<td width="150px" align="center" style="border: black 1px solid; border-collapse: collapse; background-color:#CAC7C6;">
					<font face="Arial, Helvetica, sans-serif" size="2">
					<strong>Porcentaje de Detracción (
					...
					<xsl:for-each select="//ext:UBLExtensions/ext:UBLExtension/ext:ExtensionContent/sac:AdditionalInformation/sac:AdditionalMonetaryTotal">
						...
						<xsl:if test="//cbc:UBLVersionID='2.1'">
					    <xsl:value-of select="//pe:Invoice/cac:PaymentTerms/cbc:PaymentPercent"/>
						</xsl:if>
						%)</strong>
					</font>
				</td>
			...
			<tr>
				<td align="center" style="border: black 1px solid; border-collapse: collapse;">
					<font face="Arial, Helvetica, sans-serif" size="2">
						Banco de la Nación
					</font>
				</td>
				<td align="center" style="border: black 1px solid; border-collapse: collapse;">
					...
					<xsl:if test="//cbc:UBLVersionID='2.0'">
						...
						<xsl:if test="//cbc:UBLVersionID='2.1'">
						<xsl:value-of select="//pe:Invoice/cac:PaymentMeans/cac:PayeeFinancialAccount/cbc:ID"/> 
						</xsl:if>
					</font>
				</td>
				<td align="center" style="border: black 1px solid; border-collapse: collapse;">
					...
					<xsl:if test="//cbc:UBLVersionID='2.0'">
						...
						<xsl:if test="//cbc:UBLVersionID='2.1'">
						<!-- <xsl:value-of select="//pe:Invoice/cac:PaymentTerms/cbc:Amount"/> -->
						<xsl:for-each select="/pe:Invoice/cac:PaymentTerms">
							<xsl:if test="cbc:ID ='Detraccion'">	
								S/. &#xA0; <xsl:value-of select="format-number(cbc:Amount,'###,###,##0.00','pen')"/>
							</xsl:if>
						</xsl:for-each>
						</xsl:if>
					</font>
	...
	<xsl:template name="Total">
		...
		<table border="0" width="100%" cellpadding="1" cellspacing="0" bordercolor="#000000" heigth="100%">
			...
			<!--OPERACIÃ“N INAFECTA-->	
				...
				<!--OPERACIÃ“N EXPORTACIÓN-->	
				<tr>
					<td valign="top" width="60%" align="left">
					<font face="Arial, Helvetica, sans-serif" size="2">
						<Strong>OP. EXPORTACIÓN&#160;
						</Strong>
					</font>
					</td>
					<td align="left" >
