					...
					<td vAlign="top" width="100%">
						<table border="0" width="100%" bordercolor="#000000" cellpadding="2" cellspacing="2">
							<tbody>
								<tr>
									<td width="13%">
										<font face="Arial, Helvetica, sans-serif" size="3"><strong>Señor(es)</strong></font>
									</td>
									<td width="87%">
								...
								<tr>
									<td width="13%">
										<font face="Arial, Helvetica, sans-serif" size="3"><strong>R.U.C.</strong></font>
									</td>
									<td width="87%">
										<font face="Arial, Helvetica, sans-serif" size="3">:
								...
								<tr>
									<td width="13%">
										<font face="Arial, Helvetica, sans-serif" size="3"><strong>Fecha Emisión</strong></font>
									</td>
