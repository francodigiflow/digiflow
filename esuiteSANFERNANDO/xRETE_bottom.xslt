			...
			<tbody>
				<tr>
					<td valign="baseline" width="100%" align="center">
						<font face="Arial, Helvetica, sans-serif" size="3">Representación impresa del Comprobante de Retención Electrónico
							<br/>Podrá ser consultado en nuestra web https://www.san-fernando.com.pe
							<br/>Autorizado mediante RS N° 0180050001154/SUNAT 
							<!--<br/>
