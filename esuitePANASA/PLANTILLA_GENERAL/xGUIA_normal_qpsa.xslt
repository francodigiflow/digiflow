...
<!--		</xsl:if>-->
	...
	<xsl:include href="xGUIA_encab_qpsa.xslt"/>
	<xsl:include href="xGUIA_detalle_qpsa.xslt"/>
	<xsl:include href="xGUIA_bottom_qpsa.xslt"/>
	<xsl:include href="xGUIA_datos_qpsa.xslt"/>
	<xsl:include href="xGUIA_total_qpsa.xslt"/>
