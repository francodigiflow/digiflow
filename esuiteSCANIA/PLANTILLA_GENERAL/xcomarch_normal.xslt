				...
				<h1>
					<table cellSpacing="1" width="100%" border="0">
						<tbody>
							...
							<tr width="100%">
								<td>
									<xsl:call-template name="tmpDatosAdicional"/>
								</td>
							</tr>
							<tr width="100%">
								<td>
							...
							<tr width="100%">
								<td>
									<xsl:call-template name="bottom_final"/>
								</td>
							</tr>
						</tbody>
					</table>
