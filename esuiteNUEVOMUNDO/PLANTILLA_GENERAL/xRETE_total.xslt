...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:ds="http://www.w3.org/2000/09/xmldsig#" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:pe="urn:oasis:names:specification:ubl:schema:xsd:Invoice-2"
                xmlns:pe1="urn:oasis:names:specification:ubl:schema:xsd:CreditNote-2" xmlns:pe2="urn:oasis:names:specification:ubl:schema:xsd:DebitNote-2" xmlns:re="urn:sunat:names:specification:ubl:peru:schema:xsd:Retention-1" xmlns:ext="urn:oasis:names:specification:ubl:schema:xsd:CommonExtensionComponents-2"
				...
				<tr>
					<td align="left" width="100%">
						...
						<font color="#000000" size="2" face="Arial, Helvetica, sans-serif">
							...
							<xsl:for-each select="//ext:UBLExtensions/ext:UBLExtension/ext:ExtensionContent/re:DatosAdicionales/re:DatoAdicional">
								<xsl:if test="re:Codigo='1'">
									<xsl:value-of select="re:Valor"/>
								</xsl:if>
							</xsl:for-each>
						</font>
						<!--</font> -->
