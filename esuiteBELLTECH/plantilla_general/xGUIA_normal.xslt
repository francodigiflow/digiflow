					...
					1 de <xsl:value-of select="$totalpag"/> 
						...
						<tr>
							<td>
								...
								<font face="Arial, Helvetica, sans-serif" size="2" align="center">
								<br/>
								</font>
							</td>
						</tr>
