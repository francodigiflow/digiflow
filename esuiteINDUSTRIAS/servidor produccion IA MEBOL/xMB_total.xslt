		...
		<table border="0" width="80%" cellpadding="0" cellspacing="0">
			<tr>
				...
				<td width="39" align="left">
					<font face="Arial, Helvetica, sans-serif" size="1">		
						<u><strong>FOR PAYMENTS FROM OUTSIDE THE USA</strong></u> <!-- COLMNA 1 FILA 1 -->
					</font>
				</td>
			<td width="1%">
			&#xA0;
				...
				<td width="39%" align="left">
					<font face="Arial, Helvetica, sans-serif" size="1">
						<u><strong>FOR PAYMENTS FROM A BANK WITHIN THE USA</strong></u> <!-- COLMNA 2 FILA 1 -->	
					</font>
				</td> 
			</tr>
			...
			<tr>	
				<td width="39%" align="left">
					<font face="Arial, Helvetica, sans-serif" size="1">
						<strong>BENEFICIARY BANK : </strong>BANCO DE CREDITO DEL PERU - MIAMI AGENCY <!-- COLMNA 1 FILA 2  -->	
					</font>
				</td> 
			<td width="1%">
			&#xA0;
				...
				<td width="39%" align="left">
					<font face="Arial, Helvetica, sans-serif" size="1">
						<strong>BENEFICIARY BANK : </strong>BANCO DE CREDITO DEL PERU - MIAMI AGENCY <!-- COLMNA 2 FILA 2 -->	
					</font>
				</td>
			</tr>
			...
			<tr>
				<td width="39%" align="left">
					<font face="Arial, Helvetica, sans-serif" size="1">
						<strong>ADRESS : </strong>121 ALHAMBRA PLAZA, SUITE 1200, CORAL GABLES, FL 33134<!-- COLMNA 1 FILA 3 -->	
					</font>
				</td>
			<td width="1%">
			&#xA0;
				...
				<td width="39%" align="left">
					<font face="Arial, Helvetica, sans-serif" size="1">
						<strong>ADRESS : </strong>121 ALHAMBRA PLAZA, SUITE 1200, CORAL GABLES, FL 33134 <!-- COLMNA 2 FILA 3 -->	
					</font>
				</td>	
			</tr>
			...
			<tr>
				<td width="39%" align="left">
					<font face="Arial, Helvetica, sans-serif" size="1">
						<strong>SWIFT : </strong>BCPLUS33 <!-- COLMNA 1 FILA 4 -->	
					</font>
				</td>
			<td width="1%">
			&#xA0;
				...
				<td width="39%" align="left">
					<font face="Arial, Helvetica, sans-serif" size="1">
						<strong>ABA : </strong>067015355 <!-- COLMNA 2 FILA 4 -->	
					</font>
				</td>
			</tr>
			...
			<tr>
				<td width="39" align="left">
					<font face="Arial, Helvetica, sans-serif" size="1">
						<strong>ABA : </strong>067015355 <!-- COLMNA 1 FILA 5 -->	
					</font>
				</td>
			<td width="1%">
			&#xA0;
				...
				<td width="39%" align="left">
					<font face="Arial, Helvetica, sans-serif" size="1">
						<strong>BENEFICIARY ACCOUNT NAME : </strong>MEBOL SAC  <!-- COLMNA 2 FILA 5 -->	
					</font>
				</td>
			</tr>
			...
			<tr>
				<td width="39%" align="left">
					<font face="Arial, Helvetica, sans-serif" size="1">
						<strong>INTERMEDIARY BANK : </strong>STANDARD CHARTERED BANK - NEW YORK<!-- COLMNA 1 FILA 6 -->	
					</font>
				</td>
			<td width="1%">
			&#xA0;
				...
				<td width="39%" align="left">
					<font face="Arial, Helvetica, sans-serif" size="1">
						<strong>BENEFICIARY ACCOUNT NUMBER : </strong>201030010007046 <!-- COLMNA 2 FILA 6 -->	
					</font>
				</td>
			</tr>	
			...
			<tr>
				<td width="39%" align="left">
					<font face="Arial, Helvetica, sans-serif" size="1">
						<strong>SWIFT : </strong>SCBLUS33 <!-- COLMNA 1 FILA 7 -->	
					</font>
				</td>
			<td width="1%">
			&#xA0;
			</td>				
				<td width="39%" align="left"><!-- COLMNA 2 FILA 7 -->	
					<!-- COLM vacia -->
				</td>
			...
			<tr>
				<td width="39%" align="left">
					<font face="Arial, Helvetica, sans-serif" size="1">
						<strong>BENEFICIARY ACCOUNT NAME : </strong> MEBOL SAC <!-- COLMNA 1 FILA 8 -->	
					</font>
				</td>
			<td width="1%">
			&#xA0;
			</td>
				<td width="39%" align="left"><!-- COLMNA 2 FILA 8 -->	
					<!-- COLM vacia -->
				</td>
			...
			<td width="39%" align="left">
					<font face="Arial, Helvetica, sans-serif" size="1">
						<strong>BENEFICIARY ACCOUNT NUMBER : </strong>201030010007046 <!-- COLMNA 1 FILA 9 -->	
					</font>
				</td>
			<td width="1%">
			&#xA0;
			</td>
				<td width="39%" align="left"><!-- COLMNA 2 FILA 9 -->	
					<!-- COLM vacia -->
				</td>
			</tr>
		</table>
				...
				<td width="100%" valign="top" align="justify">
					<font face="Arial, Helvetica, sans-serif" size="1">
						<xsl:choose>
							...
							<xsl:otherwise>
								** MEBOL S.A.C. ES AGENTE DE RETENCIÓN **
							</xsl:otherwise>
						</xsl:choose>
					</font>
				</td>
