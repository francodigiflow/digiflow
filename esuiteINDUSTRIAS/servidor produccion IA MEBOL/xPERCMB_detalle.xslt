					...
					<table rules="cols" border="1" width="100%" bordercolor="#000000" cellpadding="4" cellspacing="0">
						<tr>
							...
							<td width="6%" align="center" rowspan="2">
								<font face="Arial, Helvetica, sans-serif" size="2">
									<strong>N° Cobro</strong>
								</font>
							</td>
							<td width="10%" align="center" rowspan="2">
								<font face="Arial, Helvetica, sans-serif" size="2">
									<strong>Importe de Cobro (Moneda Origen)</strong>
								</font>
							</td>
							...
							<td width="10%" align="center" rowspan="2">
								<font face="Arial, Helvetica, sans-serif" size="2">
									<strong>Importe de Percepción en Soles</strong>
								</font>
							</td>
							<td width="10%" align="center" rowspan="2">
								<font face="Arial, Helvetica, sans-serif" size="2">
						...
						<!--<tr>
							...
							<td width="10%" align="center">
								<font face="Arial, Helvetica, sans-serif" size="2">
									<strong>IMPORTE DE PERCEPCION (MONEDA NACIONAL)</strong>
								</font>
							</td>
							<td width="10%" align="center">
								<font face="Arial, Helvetica, sans-serif" size="2">
									<strong>IMPORTE NETO COBRADO (MONEDA NACIONAL)</strong>
								</font>
							</td>
						</tr>-->
					</table>
