			...
			<xsl:for-each select="//cac:AdditionalDocumentReference">
				<tr>
					<td style="border:solid 1px" align="center">
						<font face="Arial, Helvetica, sans-serif" size="1">
							<xsl:choose>
								<xsl:when test="//cbc:DocumentTypeCode='02'">FACTURA ELECTRÓNICA</xsl:when>
								<xsl:when test="//cac:PrepaidPayment/cbc:ID/@schemeID='03'">BOLETA ELECTRÓNICA</xsl:when>
								<xsl:otherwise>Documento NN</xsl:otherwise>								
				...
				<td width="100%" valign="top" align="justify">
					<font face="Arial, Helvetica, sans-serif" size="1">
						<xsl:choose>						
							...
							<xsl:otherwise>** MEBOL GF no es agente de retención.**</xsl:otherwise>
						</xsl:choose>
					</font>
				</td>
			</tr>
				...
				<td align="left" width="100%">
					<font face="Arial, Helvetica, sans-serif" size="1">
						<xsl:if test="//cbc:Note[@languageLocaleID='2006']!=''">
								<strong>OPERACIÓN SUJETA A DETRACCIÓN</strong><br/>
								CUENTA DE DETRACCIÓN BANCO DE LA NACIÓN: <xsl:value-of select="$DetraCuenta"/>.<br/>
						</xsl:if>
					</font>
				</td>
			</tr>
		...
		<table style="border: 1px solid black; border-collapse: collapse;" rules="groups" width="100%" bordercolor="#000000" cellpadding="2" cellspacing="0">
			...
			<thead style="border: 1px solid black;">
				<tr>
					...
					<td width="12.5%" align="center" style="border:solid 1px black;background-color:#C0C0C0">
						<b>
							<font face="Arial, Helvetica, sans-serif" size="1">OPERACIÓN <br/>  GRATUITA</font>
						</b>
					</td>
					</xsl:if>
					<td width="12.5%" align="center" style="border:solid 1px black;background-color:#C0C0C0">
					...
					<td width="12.5%" align="center" style="border:solid 1px black;background-color:#C0C0C0">
						<b>
							<font face="Arial, Helvetica, sans-serif" size="1">OPERACIÓN<br/>EXPORTACION</font>
						</b>
					</td>
					</xsl:if>
					<td width="12.5%" align="center" style="border:solid 1px black;background-color:#C0C0C0">
